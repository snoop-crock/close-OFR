...
class ModelTrainer:
    ...
    def save_model(self, model: CatBoostRegressor, filename: str = "final_model.cbm") -> None:
        """
        Сохраняет модель CatBoost в файл
        ...
        """
        try:
            model_path = Path(self.config.REPORTS_DIR) / filename
    ...
    def optimize_hyperparameters(self,
        ...
        def objective(trial: optuna.Trial) -> float:
            ...
            try:
                ...
                # Используем MSE в качестве метрики для оптимизации
    ...
    def cross_validate(self,
        ...
        for fold, (train_idx, val_idx) in enumerate(kf.split(X), 1):
            ...
            try:
                ...
                # Расчет метрик
                metrics['mse'].append(mean_squared_error(y_val, preds))
                metrics['rmse'].append(
        ...
        for metric in ['mse', 'rmse', 'mae', 'r2', 'spearman']:
            logger.info(
